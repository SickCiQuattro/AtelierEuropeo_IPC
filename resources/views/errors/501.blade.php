        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-xl-6">
                <div class="text-center mb-4">
                    ...
                    <div class="mb-4">
                        <img src="{{ url('/') }}/img/comingSoon.png" alt="Prossimamente" class="img-fluid rounded shadow-sm"
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="mb-0">
                                <i class="bi bi-check-circle text-success me-2"></i>
                                <a href="{{ route('contact') }}" class="text-decoration-none">Contattarci</a> per maggiori
                                informazioni
                            </li>
                        </ul>
                    </div>

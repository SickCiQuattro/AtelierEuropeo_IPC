    ...
    <div class="container py-4">
        ...
        <div class="row mb-4">
            <div class="col-12">
                ...
                <h1 class="section-subtitle text-center">Esperienze di mobilità internazionale che favoriscono l'incontro
                    tra culture diverse
                ...
                <div class="list-group">
                    <div class="list-group-item d-flex align-items-center py-2">
                        ...
                        <div>
                            ...
                            <small class="text-muted">Avere tra i 13 e i 30 anni (o più di 30 per il ruolo di team
                                leader)</small>
                        </div>
                    </div>
                    <div class="list-group-item d-flex align-items-center py-2">
                    ...
                    <div class="list-group-item d-flex align-items-center py-2">
                        ...
                        <div>
                            ...
                            <small class="text-muted">Disponibilità a comunicare in inglese (livello base
                                sufficiente)</small>
                        </div>
                    </div>
                </div>
                ...
                <ol class="list-group list-group-numbered">
                    <li class="list-group-item d-flex justify-content-between align-items-start py-2">
                        <div class="ms-2 me-auto">
                            ...
                            <small class="text-muted">Seguire i canali di comunicazione di Atelier Europeo (sito web, social
                                media, newsletter)
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-start py-2">
                        <div class="ms-2 me-auto">
                            ...
                            <small class="text-muted">Manifestare il proprio interesse contattando Atelier Europeo con
                                anticipo,

...
@section('title', 'AE - Archivio Progetti')
...
@section('body')
    <main class="container py-5 projects-list-page">
        ...
        <div class="row g-0">
            <div class="col-12">
                ...
                <div class="search-filter-wrapper position-sticky bg-white py-3 px-3 shadow-sm mb-3">
                    <form method="GET" action="{{ route('project.portfolio') }}">
                        ...
                        <div class="input-group">
                            <span class="input-group-text" id="portfolio-search-icon" aria-hidden="true">
                            ...
                            <div class="d-flex flex-wrap align-items-center gap-2">
                                ...
                                @foreach ((array) request('category', []) as $categoryId)
                                    ...
                                    @if ($activeCategory)
                                        <span class="badge bg-secondary rounded-pill">
                                            ...
                                            <a href="{{ route('project.portfolio', $removeCategoryParams) }}"
                                                class="text-white text-decoration-none ms-1"
                                ...
                                @if (request()->filled('date_from'))
                                    ...
                                    <span class="badge bg-secondary rounded-pill">
                                        ...
                                        <a href="{{ route('project.portfolio', $removeDateFromParams) }}"
                                            class="text-white text-decoration-none ms-1"
                                ...
                                @if (request()->filled('date_to'))
                                    ...
                                    <span class="badge bg-secondary rounded-pill">
                                        A: {{ request('date_to') }}
                                        <a href="{{ route('project.portfolio', $removeDateToParams) }}"
                                            class="text-white text-decoration-none ms-1"
                ...
                @if ($projects->isEmpty())
                    <div class="my-4">
                        <div class="text-center mb-0" role="status">
                            Nessun progetto completato trovato con i criteri selezionati.
                        </div>
                    </div>
                @else
                    <div class="my-4">
        ...
        <div class="modal fade" id="portfolioFiltersModal" tabindex="-1" aria-labelledby="portfolioFiltersModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="portfolioFiltersModalLabel">Filtri Progetti</h5>

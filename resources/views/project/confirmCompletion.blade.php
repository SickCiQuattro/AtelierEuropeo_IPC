        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-xl-6">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted">
                        Stai per contrassegnare il progetto come completato. Una volta completato, il progetto non potrà più
                        essere modificato.
                    </p>
                </div>
                        ...
                        <div class="card border-warning h-100 d-flex">
                            ...
                            <div class="card-body text-center d-flex flex-column">
                                ...
                                <p class="text-muted mb-3 flex-grow-1">
                                    Il progetto <strong>sarà contrassegnato come completato</strong> e non potrà più essere
                                    modificato.
                                </p>
                            ...
                            <div class="card-body text-center d-flex flex-column">
                                ...
                                <div class="mt-auto">
                                    <a href="{{ route('project.edit', ['id' => $project->id]) }}"
                                        class="btn btn-ae btn-ae-secondary btn-lg w-100">
                                        <i class="bi bi-arrow-left me-2"></i>
                                        Torna alla Modifica
                                    </a>
                                </div>

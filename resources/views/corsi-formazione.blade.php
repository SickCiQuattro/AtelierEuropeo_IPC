    ...
    <div class="container py-4">
        ...
        <div class="row mb-4">
            <div class="col-12">
                ...
                <h1 class="section-subtitle text-center">Opportunità di sviluppo professionale per Youth Workers e operatori
                    giovanili,
                ...
                <ol class="list-group list-group-numbered">
                    <li class="list-group-item d-flex justify-content-between align-items-start py-2">
                        <div class="ms-2 me-auto">
                            ...
                            <small class="text-muted">Monitora regolarmente il sito di Atelier Europeo e i social media per
                                rimanere
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-start py-2">
                        <div class="ms-2 me-auto">
                            ...
                            <small class="text-muted">CV in formato Europass (inglese), lettera motivazionale specifica per
                                il corso,
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-start py-2">
                        <div class="ms-2 me-auto">
                            ...
                            <small class="text-muted">Invia la candidatura completa rispettando scadenze e requisiti
                                specifici
